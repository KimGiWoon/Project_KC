...
public class EventSOManager : MonoBehaviour
{
    public static EventSOManager Instance;
    ...
    {
        // "Chart/EncounterData" 경로에 있는 모든 EncounterDataSO 파일을 불러옵니다.
        allEncounterSOs = Resources.LoadAll<EncounterDataSO>("Chart/EncounterData").ToList();
        Debug.Log($"총 {allEncounterSOs.Count}개의 인카운터 SO 파일을 불러왔습니다.");
    }
