    ...
    public partial class UIManager
    {
        ...
        private void OpenSignInScene(UIName uiName)
        {
            switch (uiName)
            {
                ...
                case UIName.ImagePrefabLoadingUI: ConnectImagePrefabLoadingUI(uiName); break;
            }
        }
        ...
        private void OpenLobbyScene(UIName uiName)
        {
            switch (uiName)
            {
                ...
                case UIName.GachaConfirmUI: ConnectGachaConfirmUI(uiName); break;
                case UIName.GachaNotEnoughUI: ConnectNotEnoughUI(uiName); break;
